...
import axis.com.vioslip.Admin.Violations.JSONfunctions;
import axis.com.vioslip.Admin.Violations.ListViewAdapter;
import axis.com.vioslip.R;


public class ViolationListProf extends AppCompatActivity{
    // Declare Variables
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        int perm = PermissionChecker.checkSelfPermission(ViolationListProf.this, permission);

        if (perm == PermissionChecker.PERMISSION_GRANTED) {
            // good to go

        } else {
            ActivityCompat.requestPermissions(ViolationListProf.this,
                    new String[]{Manifest.permission.READ_EXTERNAL_STORAGE},
                    1);
            // permission not granted, you decide what to do
        }
        addvio = (Button)findViewById(R.id.add_vio);
        addvio.setVisibility(View.GONE);
    ...
    private class DownloadJSON extends AsyncTask<Void, Void, Void> {
        ...
        protected void onPreExecute() {
            ...
            mProgressDialog = new ProgressDialog(ViolationListProf.this);
        ...
        protected void onPostExecute(Void args) {
            ...
            adapter = new ListViewAdapter(ViolationListProf.this, arraylist);
        ...
        switch (requestCode) {
            case 1: {
                ...
                if (grantResults.length > 0
                    ...
                    Toast.makeText(ViolationListProf.this, "Permission denied to read your External storage", Toast.LENGTH_SHORT).show();
                }
                return;
            }
